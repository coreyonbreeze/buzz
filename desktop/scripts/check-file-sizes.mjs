...
const overrides = new Map([
  ...
  ["src/features/onboarding/ui/AssistantSetupStep.tsx", 590], // personal-assistant onboarding orchestrator: single-agent dedupe/reuse, fresh-process restart on reset, observer transcript wiring, local acks, send path, finish flow (pure helpers in lib/assistantSetupHelpers.ts, terminal UI in ui/AssistantTerminal.tsx)
